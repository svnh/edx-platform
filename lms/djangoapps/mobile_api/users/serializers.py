...
class CourseEnrollmentSerializer(serializers.ModelSerializer):
    ...
    # @classmethod
    # def set_course_catalog(cls, user, course_keys):
    #     """
    ...
    #     #     request_cache_dict['course_marketing_url_dict'] = get_run_marketing_urls(user, course_keys)
    #     if settings.FEATURES.get('ENABLE_MKTG_SITE'):
    #         cls.context['marketing_urls_against_course_keys'] = get_run_marketing_urls(user, course_keys)

    @classmethod
    def get_course_catalog_run_cache(cls, user, course_keys):
        """
        """
        if settings.FEATURES.get('ENABLE_MKTG_SITE'):
