...
class ModuleStoreSerializer(object):
    ...
    def __init__(self, courses=None, skip=None):
        ...
        Args:
            courses: string serialization of course keys
            skip: string serialization of course keys
        """
        if courses:
    ...
    def get_command_last_run(course_key, graph):
        ...
        Returns: None, if there's no record of this command last being run, or
            the datetime that the command was last run, converted into text.
    ...
    def get_course_last_published(course_key):
        ...
        Returns: None, if there's no record of the last time this course was
            published, or the datetime the course was last published at,
            converted into text.
        """
        try:
